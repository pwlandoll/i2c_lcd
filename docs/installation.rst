...
The sources for I2C LCD can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/pwlandoll/i2c_lcd
.. _tarball: https://github.com/pwlandoll/i2c_lcd/tarball/master
